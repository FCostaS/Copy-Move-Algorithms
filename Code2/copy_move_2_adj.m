...
% There are slight modifications to the algorithm as described to help 
...
% not_color indicates whether the input image is a color image (nxmx3) or
% not (nxm)

function [image_copy,timestemp] = copy_move_2_adj(color_image, quality_factor, threshold, not_color)
tic
%===================== Initializations ========================
%%
